...
- Verificación previa de espacio libre en el destino antes de copiar.
...
- Journal de operaciones: detecta y limpia restos de un backup interrumpido
  (corte de luz, disco desconectado) la próxima vez que se usa ese destino.
- Pestaña **Comparar**: elegís qué carpetas del backup revisar y contra qué
  ...
  usada para no volver a preguntar la próxima vez.
